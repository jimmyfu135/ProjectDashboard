...
for(var i = 0; i < common_css_files.length; i++){
	document.write("<link rel='stylesheet' type='text/css' href='/ProjectDashboard/common/editgrid/"+common_css_files[i]+"'>");
}
/**
 * 导入JS文件
 */
for(var i = 0; i < common_js_files.length; i++){
	document.write("<script type='text/javascript' src='/ProjectDashboard/common/editgrid/"+common_js_files[i]+"'></script>");
}
